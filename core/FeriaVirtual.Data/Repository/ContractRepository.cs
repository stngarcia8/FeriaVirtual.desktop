...
namespace FeriaVirtual.Data.Repository{
    ...
    public class ContractRepository : Repository{
        ...
        private ContractRepository(int profileId){
            ...
            emailNotifier = EmailContractNotifier.CreateNotifier();
        }
        ...
        public ContractDto FindContractToPublishById(string contractId, string clientId){
            Sql.Clear();
            Sql.Append(
                "select * from fv_user.vwContratoPorAsociado where id_contrato=:pIdContrato and id_cliente=:pIdCliente ");
            var querySelect = DefineQuerySelect(Sql.ToString());
