...
namespace FeriaVirtual.Business.Stats{
    ...
    public class ReportUsecase{
        ...
        public void SendReportToEmail(IList<ReportRecipientsDto> recipients){
            if (recipients.Count.Equals(0)) throw new Exception("La lista de destinatarios no puede estar vacia.");
            repository.NotifyReportByEmail(recipients);
        }
